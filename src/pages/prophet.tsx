  ...
  React.useEffect(() => {
    if (currentEthBalance) {
      ...
      */
      ...
      const ethBalanceWithMinimumAmountRemoved = Number(currentEthBalance["value"]) * 0.97;
    ...
    <div className="page" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "30px" }}>
      ...
      <div className="prophettop">
              ...
              <TableBody>
                <TableRow>
                  <TableCell className={styles.table}>
                    $PROPHET tokens owned by 0x{String(address).slice(-4)}:
                  </TableCell>
                  <TableCell className={styles.table}>
                    {Math.floor(Number(toWei(Number(currentTokenBalanceState), "wei")) / 1000000000000000000)}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className={styles.table}>Total $PROPHET tokens staked:</TableCell>
                  <TableCell className={styles.table}>
                    {Math.floor(Number(totalStakedTokensState) / 1000000000000000000)}
                  </TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className={styles.table}>$PROPHET staked by 0x{String(address).slice(-4)}:</TableCell>
                  <TableCell className={styles.table}>
                    {Math.floor(Number(userStakedTokensState) / 1000000000000000000)}
                  </TableCell>
                </TableRow>
              </TableBody>
            </Table>
        ...
        <div className="container">
          <Typography className={styles.comment}>
            ...
            {Math.floor(Number(toWei(Number(tokensThatCanBeBoughtWithCurrentEthState), "wei")) / 1000000000000000000)}{" "}
            $PROPHET tokens!
          </Typography>
        </div>
        <div className="container">
          ...
          <Button
            ...
            onClick={() => {
              ...
              setEthToUseInBuyWei(BigInt(Number(currentETHBalanceState) * 0.97));
            }}
          >
            MAX
          </Button>
      ...
      <div>
        <ProphetApproveAndStakeCard
          ...
          cardTitle="Stake $PROPHET"
          currentTokenBalanceState={currentTokenBalanceState}
          setCurrentTokenBalanceState={setCurrentTokenBalanceState}
          maxApprovalAmount={maxApprovalAmount}
        ></ProphetApproveAndStakeCard>
        <ProphetApproveAndUnstakeCard
          mounted={mounted}
          isConnected={isConnected}
          cardTitle="Unstake $PROPHET"
          currentTokenBalanceState={currentTokenBalanceState}
          setCurrentTokenBalanceState={setCurrentTokenBalanceState}
        ></ProphetApproveAndUnstakeCard>
      </div>
              ...
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[5]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[4]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[3]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[2]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[1]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  <CircularProgress
                    ...
                    variant="determinate"
                    value={(Number(tokensRemaining[0]) / 20000000000) * 100}
                  />
                </TableCell>
              </TableRow>
            </TableBody>
